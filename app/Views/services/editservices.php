        ...
        <div class="col-lg-12">
            <div class="card mt-24">
                <div class="card-header border-bottom">
                    <h6 class="text-xl mb-0">Edit Service Details</h6>
                </div>
                <div class="card-body p-24">
                    <form action="<?= site_url('serviceedit-form') ?>" method="post" enctype="multipart/form-data" class="d-flex flex-column gap-20">
                        <?php if (!empty($service)) : ?>
                            <div class="row">
                                <input type="hidden" id="pid" name="pid" value="<?= esc($service['id']); ?>">
                                <div class="col-md-6">
                                    ...
                                    <input type="text" class="form-control border border-neutral-200 radius-8" id="ptitle" name="ptitle"
                                        placeholder="Enter Post Title" value="<?= esc($service['title']); ?>">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <select class="form-control form-select border border-neutral-200 radius-8" id="pcategory" name="pcategory">
                                        ...
                                        <option <?php if ($service['category'] == "Airport Pickup") { ?> selected <?php } ?> value="Airport Pickup">Airport Pickup</option>
                                        <option <?php if ($service['category'] == "Gifting") { ?> selected <?php } ?> value="Gifting">Gifting</option>
                                        <option <?php if ($service['category'] == "Rental") { ?> selected <?php } ?> value="Rental">Rental</option>
                                    </select>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="text" class="form-control border border-neutral-200 radius-8" id="price" name="price"
                                        placeholder="Enter Price" value="<?= esc($service['price']); ?>">
                            ...
                            <textarea name="editor_content" id="editor_content" style="display: none;"><?= esc($service['description']) ?></textarea>


                            <div class="row">
                                <!-- Left side: Upload service Images -->
                                <div class="col-md-8">
                                    <label class="form-label fw-bold text-neutral-900">Upload Service Images </label>
                                ...
                                <div class="col-md-4">
                                    <label class="form-label fw-bold text-neutral-900">Saved Services Images</label>
                                    <div class="card h-100 p-0">
                                        <div class="card-body p-24">
                                            <?php if (!empty($serviceimages)): ?>
                                                <table class="table table-bordered">
                                                    ...
                                                    <tbody>
                                                        <?php foreach ($serviceimages as $serviceimages): ?>
                                                            <tr>
                                                                <td>
                                                                    <?php if (!empty($serviceimages->image_path)): ?>
                                                                        <img src="<?= base_url('public/uploads/services/' . $serviceimages->image_path) ?>"
                                                                            alt="service Image"
                                                                ...
                                                                <td>
                                                                    <form action="<?= base_url('service/delete-image/' . $serviceimages->id) ?>" method="post" onsubmit="return confirm('Are you sure you want to delete this image?');">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <select class="form-control form-select border border-neutral-200 radius-8" id="pstatus" name="pstatus">
                                        <option <?php if ($service['status'] == "Active") { ?> selected <?php } ?> value="Active">Active</option>
                                        <option <?php if ($service['status'] == "Inactive") { ?> selected <?php } ?> value="Inactive">Inactive</option>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <select class="form-control form-select border border-neutral-200 radius-8" id="featured" name="featured">
                                        <option <?php if ($service['is_featured'] == "1") { ?> selected <?php } ?> value="1">Yes</option>
                                        <option <?php if ($service['is_featured'] == "0") { ?> selected <?php } ?> value="0">No</option>
