    ...
    <div class="card basic-data-table">
        ...
        <div class="card-body">
            <div class="container">
                ...
                <form method="post" action="<?= base_url('share-transactions/save') ?>" id="shareForm">
                    ...
                    <div class="form-group mt-2">
                        ...
                        <input type="number" name="member_phno" class="form-control" required>
                    </div>
                    <div class="form-group mt-2">
                    ...
                    <div class="form-group mt-2">
                        ...
                        <input type="number" name="amount_invested" id="amountInvested" class="form-control" min="0" required>
                    </div>

                    <div class="form-group mt-2">
                        <label>Shares Allocated</label>
                        <input type="number" name="shares_allocated" id="sharesAllocated" class="form-control" readonly required>
