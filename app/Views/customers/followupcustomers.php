...
<div class="dashboard-main-body">
    ...
    <div class="card h-100 p-0 radius-12 overflow-hidden">
        ...
        <div class="card-body p-40">
            <h6 class="fw-semibold mb-3"><img src="<?= base_url('public/assets/images/follow-up.png') ?>" style="width:30px;height:30px;"> CUSTOMER FOLLOWUP DETAILS</h6>
            <!-- <hr> -->

            <form action="<?= site_url('followup-form') ?>" method="post" enctype="multipart/form-data">
