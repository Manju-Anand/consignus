        ...
        <div class="card-body">
            <div class="table-responsive">
                <table class="table  border-primary-table mb-0" id="dataTable" data-page-length='10'  style="font-size:  0.875rem;">
                    ...
                    <tbody>
                        <?php if (!empty($customers)) : $u = 0;
                            foreach ($customers as $customer) :  $u++; ?>
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a href="<?= base_url('edit-customer/' . $customer['id']) ?>" title="Edit Customer Details"
...
<script>
    function confirmDelete(id) {
        if (confirm("Are you sure you want to delete this Customers Details?")) {
            window.location.href = "<?= base_url('delete-customer/') ?>" + id;
        }
    }
