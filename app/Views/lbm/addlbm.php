...
<div class="dashboard-main-body">
  ...
  <div class="card h-100 p-0 radius-12 overflow-hidden">
    ...
    <div class="card-body p-40">
      <h6 class="fw-semibold mb-3">Leadership Board Members Details</h6>
      <!-- <hr> -->

      <form action="<?= site_url('lbmadd-form') ?>" method="post" enctype="multipart/form-data">
            ...
            <div class="card h-100 border shadow-none radius-8 overflow-hidden">
              <div class="card-body p-24">
                ...
                <div class="col-sm-12 mb-10">
                  ...
                  <input type="text" class="form-control form-control-sm radius-8" id="uname" oninput="capitalizeFirstLetter(this)" placeholder="Enter LBM User Name" name="uname" value="<?= set_value('uname'); ?>">
              ...
              <div class="card-body p-24">
                ...
                <div class="col-sm-12 mb-10">
                  <label for="name" class="form-label fw-semibold text-primary-light text-sm mb-8">Full Name <span
                      class="text-danger-600">*</span></label>
                  <input type="text" class="form-control form-control-sm radius-8" id="aname" oninput="capitalizeFirstLetter(this)" placeholder="Enter Leadership Board Members Name" name="aname" value="<?= set_value('aname'); ?>">
                ...
                <div class="col-sm-12">
                  <div class="mb-20">
                    ...
                    <input type="text" class="form-control form-control-sm radius-8" id="bname" placeholder="Enter Business Name" name="bname" value="<?= set_value('bname'); ?>">
                  </div>
