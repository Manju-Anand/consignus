...
<div class="dashboard-main-body">
    <div class="d-flex flex-wrap align-items-center justify-content-between gap-3 mb-24">
        <h6 class="fw-semibold mb-0">Leadership Board Members List</h6>
    ...
    <div class="card basic-data-table">
        <div class="card-header">
            <div class="row">
                <div class="col-md-6">
                    <h5 class="card-title mb-0">Leadership Board Members List</h5>

                </div>
                <div class="col-md-6 d-flex justify-content-end">

                    <a href="<?= base_url(); ?>add-lbm"> <button type="button" class="btn btn-success-600 radius-8 px-14 py-6 text-sm right">Add New Leadership Board Member</button></a>
                </div>
            </div>
        ...
        <div class="card-body">
            <div class="table-responsive">
                <table class="table  border-primary-table mb-0" id="dataTable" data-page-length='10'  style="font-size:  0.875rem;">
                    ...
                    <tbody>
                        <?php if (!empty($lbms)) : $u = 0;
                            foreach ($lbms as $lbms) :  $u++; ?>
                                <tr>

                                    <td><a href="javascript:void(0)" class="text-primary-600"><?= esc($u) ?></a></td>
                                    <td>  <?= esc($lbms['name']) ?>  </td>
                                    <td><?= esc($lbms['email']) ?></td>
                                    <td><?= esc($lbms['contact_number']) ?></td>
                                    <td><?= esc($lbms['business_name']) ?></td>
                                    <td><?= esc($lbms['created_at']) ?></td>
                                    <td>
