                            ...
                            <div class="col-xxl-3 col-md-4 col-sm-6">
                                <div class="hover-scale-img border radius-16 overflow-hidden">
                                    ...
                                    <div class="d-flex align-items-center justify-content-between gap-10 py-16 px-24">
                                        ...
                                        <div class="d-flex align-items-center justify-content-between gap-10">
                                            <a href="<?= base_url('lbmpanel/view-property/' . $property['id']) ?>" title="View Property Details"> <button type="button" class="card-edit-button text-warning-800">
                                                    <iconify-icon icon="iconamoon:eye-light" class="icon text-dark line-height-2"></iconify-icon>
                                                </button></a>
                                ...
                                <div class="col-xxl-3 col-md-4 col-sm-6">
                                    <div class="hover-scale-img border radius-16 overflow-hidden">
                                        ...
                                        <div class="d-flex align-items-center justify-content-between gap-10 py-16 px-24">
                                            ...
                                            <div class="d-flex align-items-center justify-content-between gap-10">
                                                <a href="<?= base_url('lbmpanel/view-property/' . $property['id']) ?>" title="View Property Details"> <button type="button" class="card-edit-button text-warning-600">
                                                        <iconify-icon icon="iconamoon:eye-light" class="icon text-dark line-height-1"></iconify-icon>
                                                    </button></a>
