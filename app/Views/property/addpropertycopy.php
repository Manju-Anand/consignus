            ...
            <div class="row">
              ...
              <div class="col-md-6">
                ...
                <input type="text" class="form-control border border-neutral-200 radius-8" id="location" name="location"
                  placeholder="Enter Location"  value="<?= set_value('aname'); ?>">
                ...
                <div class="row">
                  <div class="col-md-6">
                    <input type="text" class="form-control border border-neutral-200 radius-8" id="size" name="size"
                      placeholder="Enter Size/Area"  value="<?= set_value('aname'); ?>">
              ...
              <div class="col-md-6">
                ...
                <input type="text" class="form-control border border-neutral-200 radius-8" id="bedroom" name="bedroom"
                  placeholder="Enter No of Bedrooms"  value="<?= set_value('aname'); ?>">
              ...
              <div class="col-md-6">
                ...
                <input type="text" class="form-control border border-neutral-200 radius-8" id="bathroom" name="bathroom"
                  placeholder="Enter No of Bathrooms"  value="<?= set_value('aname'); ?>">
