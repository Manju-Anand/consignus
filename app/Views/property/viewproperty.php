...
<div class="dashboard-main-body">
    ...
    <?php if (!empty($property)) : ?>
        <div class="row gy-4">
            <div class="col-lg-12">
                <div class="card p-0 radius-12 overflow-hidden gallery-scale">
                    <div class="card-body p-24">
                        <div class="row gy-4">
                            <?php if (count($propertyimages) == 1): ?>
                                <div class="col-md-12">
                                    <div class="hover-scale-img border radius-16 overflow-hidden p-8">
                                        <a target="_blank"  href="<?= base_url('public/uploads/property/' . $propertyimages[0]->image_path) ?>" class="popup-img w-100 h-100 d-flex radius-12 overflow-hidden">
                                    ...
                                    <div class="row">
                                        <?php foreach (array_slice($propertyimages, 1) as $image): ?>
                                            <div class="col-6 mb-3">
                                                <div class="hover-scale-img border radius-16 overflow-hidden p-8">
                                                    <a target="_blank" href="<?= base_url('public/uploads/property/' . $image->image_path) ?>" class="popup-img w-100 h-100 d-flex radius-12 overflow-hidden">
