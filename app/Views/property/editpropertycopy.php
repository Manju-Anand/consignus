                    ...
                    <form action="<?= site_url('propertyedit-form') ?>" method="post" enctype="multipart/form-data" class="d-flex flex-column gap-20">
                        <?php if (!empty($property)) : ?>
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <label class="form-label fw-bold text-neutral-900">Size/Area: </label>
                                    <div class="row">
                                        <?php
                                        $size_area = $property['size_area'];
                                        $size = '';
                                        $measures = '';
                                        if (preg_match('/^(\d+)\s*(\w+)$/', $size_area, $matches)) {
                                            $size = $matches[1];      // 2100
                                            $measures = $matches[2];  // sqft
                                        }

                                        ?>
                                        <div class="col-md-6">
                                            <input type="text" class="form-control border border-neutral-200 radius-8" id="size" name="size"
                                                placeholder="Enter Size/Area" value="<?= esc($size); ?>">
                                            <span class="text-danger"><?= display_errors($validation ?? null, 'size'); ?></span>
                                        </div>
                                        <div class="col-md-6">
                                            <select class="form-control form-select border border-neutral-200 radius-8" id="sizemeasure" name="sizemeasure">
                                                <option <?php if ($measures == "sqft") { ?> selected <?php } ?> value="sqft">sqft</option>
                                                <option <?php if ($measures == "acres") { ?> selected <?php } ?> value="acres">acres</option>

                                            </select>
                                            <span class="text-danger"><?= display_errors($validation ?? null, 'sizemeasure'); ?></span>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="text" class="form-control border border-neutral-200 radius-8" id="bedroom" name="bedroom"
                                        placeholder="Enter No of Bedrooms" value="<?= esc($property['bedrooms']); ?>">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="text" class="form-control border border-neutral-200 radius-8" id="bathroom" name="bathroom"
                                        placeholder="Enter No of Bathrooms" value="<?= esc($property['bathrooms']); ?>">
