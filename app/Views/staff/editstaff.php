...
<div class="dashboard-main-body">
  <div class="d-flex flex-wrap align-items-center justify-content-between gap-3 mb-24">
    ...
    <ul class="d-flex align-items-center gap-2">
      ...
      <li>-</li>
      <li class="fw-medium">Employee Details - Edit</li>
    </ul>
  </div>
  ...
  <div class="card h-100 p-0 radius-12 overflow-hidden">
    <div class="card-body p-40">
      ...
      <form action="<?= site_url('editstaff-form') ?>" method="post" enctype="multipart/form-data">
        <?php if (!empty($stafflist)) : ?>

          <input type="hidden" class="form-control radius-8" id="aid" name="aid" value="<?= esc($stafflist['id']) ?>">
          <input type="hidden" class="form-control radius-8" id="uid" name="uid" value="<?= esc($stafflist['uid']) ?>">
          <div class="row">
            <!-- *************************************************************************** -->
              ...
              <div class="card h-100 border shadow-none radius-8 overflow-hidden">
                <div class="card-body p-24">
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-6">
                      <div class="avatar-upload">
                        ...
                        <div class="avatar-preview">
                          <div style='background-image: url("<?= base_url('public/uploads/' . esc($stafflist['profile_pic'])) ?>");  background-size: cover;
                  ...
                  <div class="col-sm-12 mb-10">
                    ...
                    <input type="text" class="form-control form-control-sm  radius-8" id="uname" oninput="capitalizeFirstLetter(this)" placeholder="Enter Employee User Name" name="uname" value="<?= esc($stafflist['username']); ?>">
                  ...
                  <div class="col-md-12">
                    ...
                    <div class="position-relative mb-15">
                      <div class="icon-field">
                        ...
                        <input type="password" class="form-control form-control-sm h-56-px bg-neutral-50 radius-12" value="<?= esc($stafflist['cmded']);  ?>" name="password" id="password" placeholder="Password">
                      </div>
                ...
                <div class="card-body p-24">
                  ...
                  <div class="col-sm-12 mb-10">
                    <label for="name" class="form-label fw-semibold text-primary-light text-sm mb-8">Full Name <span
                        class="text-danger-600">*</span></label>
                    <input type="text" class="form-control form-control-sm radius-8" id="aname" oninput="capitalizeFirstLetter(this)" placeholder="Enter Employee Name" name="aname" value="<?= esc($stafflist['full_name']); ?>">
                  ...
                  <div class="col-sm-12">
                    <div class="mb-20">
                      ...
                      <input type="email" class="form-control form-control-sm radius-8" id="aemail" placeholder="Enter Email Id" name="aemail" value="<?= esc($stafflist['email']); ?>">
                    </div>
                  ...
                  <div class="col-sm-12">
                    <div class="mb-20">
                      ...
                      <input type="text" class="form-control form-control-sm radius-8" id="addr" placeholder="Enter Address" name="addr" value="<?= esc($stafflist['address']); ?>">
                    </div>
                  ...
                  <div class="col-sm-12">
                    <div class="mb-20">
                      ...
                      <input type="text" class="form-control form-control-sm radius-8" id="dept" placeholder="Enter Department" name="dept" value="<?= esc($stafflist['department']); ?>">
                    </div>
                  ...
                  <div class="col-sm-12">
                    <div class="mb-20">
                      <label for="name" class="form-label fw-semibold text-primary-light text-sm mb-8">Phone No <span
                          class="text-danger-600">*</span></label>
                      <input type="number" class="form-control form-control-sm radius-8" id="aphone" placeholder="Enter Phone No" name="aphone" value="<?= esc($stafflist['phone']); ?>">
                    </div>
                  ...
                  <div class="col-sm-12">
                    <div class="mb-20">
                      ...
                      <select class="form-control form-control-sm radius-8 form-select" id="role" name="role">
                        ...
                        <option <?php if ($stafflist['role'] == "Admin") { ?> selected <?php }  ?> value="Admin">Admin</option>
                        <option <?php if ($stafflist['role'] == "Manager") { ?> selected <?php }  ?> value="Manager">Manager</option>
                        <option <?php if ($stafflist['role'] == "SalesExecutive") { ?> selected <?php }  ?> value="SalesExecutive">Sales Executive</option>
                        <option <?php if ($stafflist['role'] == "Support") { ?> selected <?php }  ?> value="Support">Support</option>
                      </select>
                  ...
                  <div class="col-sm-12">
                    <div class="mb-20">
                      ...
                      <select class="form-control form-control-sm radius-8 form-select" id="status" name="status">
                        ...
                        <option value="Active" <?php if ($stafflist['status'] == "Active") { ?> selected <?php }  ?>>Active</option>
                        <option value="Inactive" <?php if ($stafflist['status'] == "Inactive") { ?> selected <?php }  ?>>Inactive</option>
                  ...
                  <div class="col-sm-12">
                    <div class="mb-20">
                      <label for="jdate" class="form-label fw-semibold text-primary-light text-sm mb-8">Date Joined <span
                          class="text-danger-600">*</span></label>
                      <input type="date" class="form-control form-control-sm radius-8" id="jdate" oninput="capitalizeFirstLetter(this)" placeholder="Enter Password" name="jdate" value="<?= esc($stafflist['date_joined']); ?>">
                    </div>
