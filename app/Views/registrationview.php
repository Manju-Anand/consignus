...
<head>
  ...
  <title>Consignus | Registartion</title>
...
<section class="auth bg-base d-flex flex-wrap">  
    ...
    <!-- h-100 -->
        <div class="d-flex align-items-center flex-column  justify-content-center">
            <img src="<?= base_url(); ?>public/assets/images/auth/register.jpg" alt="">
        </div>
    </div>
    <div class="auth-right py-32 px-24 d-flex flex-column justify-content-center">
        <div class="max-w-464-px mx-auto w-100">
            <div>
                <a href="" class="mb-20 max-w-290-px">
                    <img src="<?= base_url(); ?>public/assets/images/consignlogo.svg" alt="" width="50%">
                </a>
                <h5 class="mb-12">Sign Up to your Account</h5>
                <p class="mb-32 text-secondary-light text-lg">Welcome back! please enter your detail</p>
            </div>
            <?= form_open('registration-form'); ?>
                <div class="icon-field">
                    <span class="icon top-50 translate-middle-y">
                        <iconify-icon icon="f7:person"></iconify-icon>
                    </span>
                    <input type="text" class="form-control h-56-px bg-neutral-50 radius-12" placeholder="Username" name="username" id="username" value="<?= set_value('username'); ?>">
                </div>
                <span class="text-danger"><?= display_errors($validation ?? null, 'username'); ?></span>
                <div class="icon-field ">
                    <span class="icon top-50 translate-middle-y">
                ...
                <div class="mb-15">
                    <div class="position-relative ">
                        <div class="icon-field">
                            ...
                            <input type="password" class="form-control h-56-px bg-neutral-50 radius-12"  placeholder="Password"  name="password" id="password" value="<?= set_value('password'); ?>">
                        </div>
                    ...
                    <span class="mt-12 text-sm text-secondary-light">Your password must have at least 4 characters</span>
                </div>
                ...
                <button type="submit" name="submit" class="btn btn-primary text-sm btn-sm px-12 py-16 w-100 radius-12 mt-32"> Sign Up</button>
                ...
                <div class="mt-32 text-center text-sm">
                    <p class="mb-0">Already have an account? <a href="<?= base_url("login");?>" class="text-primary-600 fw-semibold">Sign In</a></p>
                </div>
